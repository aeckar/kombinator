    ...
    QualifiedStarToken, QualifiedCharacterToken, QualifiedTextToken, QualifiedSwitchToken
{
    ...
    override fun sequenceAt(index: Int) = getAs<SequenceSymbol,QualifiedSequenceToken>(index)
    override fun junctionAt(index: Int) = getAs<JunctionSymbol,QualifiedJunctionToken>(index)
    override fun multipleAt(index: Int) = getAs<MultipleSymbol,QualifiedMultipleToken>(index)
    override fun optionAt(index: Int) = getAs<OptionSymbol,QualifiedOptionToken>(index)
    override fun starAt(index: Int) = getAs<StarSymbol,QualifiedStarToken>(index)
    override fun characterAt(index: Int) = getAs<CharSymbol,QualifiedCharacterToken>(index)
    override fun textAt(index: Int) = getAs<StringSymbol,QualifiedTextToken>(index)
    override fun switchAt(index: Int) = getAs<SwitchSymbol,QualifiedSwitchToken>(index)

    override fun get(index: Int) = children[index]

    override fun sequences() = getAllAs<SequenceSymbol,QualifiedSequenceToken>()
    override fun junctions() = getAllAs<JunctionSymbol,QualifiedJunctionToken>()
    override fun multiples() = getAllAs<MultipleSymbol,QualifiedMultipleToken>()
    override fun options() = getAllAs<OptionSymbol,QualifiedOptionToken>()
    override fun stars() = getAllAs<StarSymbol,QualifiedStarToken>()
    override fun characters() = getAllAs<CharSymbol,QualifiedCharacterToken>()
    override fun texts() = getAllAs<StringSymbol,QualifiedTextToken>()
    override fun switches() = getAllAs<SwitchSymbol,QualifiedSwitchToken>()

    override fun sequence() = getSingleAs<SequenceSymbol,QualifiedSequenceToken>()
    override fun junction() = getSingleAs<JunctionSymbol,QualifiedJunctionToken>()
    override fun multiple() = getSingleAs<MultipleSymbol,QualifiedMultipleToken>()
    override fun option() = getSingleAs<OptionSymbol,QualifiedOptionToken>()
    override fun star() = getSingleAs<StarSymbol,QualifiedStarToken>()
    override fun character() = getSingleAs<CharSymbol,QualifiedCharacterToken>()
    override fun text() = getSingleAs<StringSymbol,QualifiedTextToken>()
    override fun switch() = getSingleAs<SwitchSymbol,QualifiedSwitchToken>()
    ...
    companion object {
        val NOTHING = ContextFreeToken(ZeroLengthSymbol("<nothing>"))
        val EMPTY = ContextFreeToken(ZeroLengthSymbol("<empty>"))
    }
}
